...
namespace TiaSoftBackend.Data.Migrations
{
    ...
    [Migration("20241009012608_BillNameAdded")]
    partial class BillNameAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiaSoftBackend.Entities.BillStatus", b =>
                {
                    b.Property<string>("BillStatusId")
                        .HasMaxLength(36)
                        .HasColumnType("varchar(36)");
            ...
            modelBuilder.Entity("TiaSoftBackend.Entities.Bill", b =>
                {
                    b.HasOne("TiaSoftBackend.Entities.BillStatus", "BillStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("TiaSoftBackend.Entities.TableEntity", b =>
                {
                    ...
                    b.HasOne("TiaSoftBackend.Entities.User", "PaymentAuthorizedByUser")
                        .WithMany()
